...
<body>
    ...
    <main>
        <!-- Banner principal -->
        <?php require_once APP_ROOT . '/views/componentes/sections/bannerprincipal.php'; ?>
        <!-- Benefícios -->
        <?php require_once APP_ROOT . '/views/componentes/sections/beneficios.php'; ?>

        <!-- Categorias em destaque -->
        <?php require_once APP_ROOT . '/views/componentes/sections/categoriasemdestaque.php'; ?>

        <!-- Produtos em destaque -->
        <?php require_once APP_ROOT . '/views/componentes/sections/produtosemdestaque.php'; ?>

        <!-- Banner de oferta -->
        <?php require_once APP_ROOT . '/views/componentes/sections/bannerdeoferta.php'; ?>
        <!-- Produtos mais vendidos -->
        <?php require_once APP_ROOT . '/views/componentes/sections/produtosmaisvendidos.php'; ?>
        <!-- Newsletter -->
        <?php require_once APP_ROOT . '/views/componentes/sections/Newsletter.php'; ?>
    </main>
